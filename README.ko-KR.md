...
<p align="center">
  <picture>
    ...
    <img src="diagrams/diagram5_report_anatomy_light.svg" alt="감사 준비 리포트의 구성: 프레임워크 이름, 애플리케이션, 모델, 날짜를 포함한 헤더, 요약 정리, 정책 결과 표, 리스크 평가 막대 차트, 시정 안내, AICertify v0.8.1 표시 푸터" width="85%" />
  </picture>
</p>
