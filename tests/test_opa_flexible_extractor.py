...
class TestFlexibleExtractor(unittest.TestCase):
    ...
    def test_extract_policy_data(self):
        ...
        policy_data = self.extractor.extract_policy_data(
            self.sample_opa_results, "test_policy"
        )
        ...
        policy_data = self.extractor.extract_policy_data(
            self.sample_opa_results, "non_existent_policy"
        )
    ...
    def test_extract_policy_results(self):
        ...
        policy_result = self.extractor.extract_policy_results(
            self.sample_opa_results, "test_policy"
        )
    ...
    def test_extract_all_policy_results(self):
        ...
        # Check second policy
        another_policy = next(
            (p for p in policy_results if p.name == "another_policy"), None
        )
