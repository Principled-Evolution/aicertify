...
def setup_deepeval_config():
    ...
    try:
        ...
        logger.info(
            "Note: To use OpenAI's API for content safety evaluation, you'll need to add your API key."
        )
        ...
        logger.info(
            f"Local project DeepEval configuration created at {project_config_path}"
        )
