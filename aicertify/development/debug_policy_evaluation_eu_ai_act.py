                ...
                if "expressions" in first_result:
                    ...
                    if len(expressions) > 0:
                        ...
                        if "value" in first_expr:
                            ...
                            version_keys = [
                                k for k in value.keys() if k.startswith("v")
                            ]
                            ...
                            for version_key in version_keys:
                                ...
                                logger.info(
                                    f"Version {version_key} has {len(version_data)} policies"
                                )
                                ...
                                for policy_name, policy_data in version_data.items():
                                    ...
                                    if has_compliance_report:
                                        compliance_report = policy_data[
                                            "compliance_report"
                                        ]
                                        logger.info(
                                            f"Compliance report keys: {list(compliance_report.keys())}"
                                        )
                                        ...
                                        if "compliant" in compliance_report:
                                            ...
                                            logger.info(
                                                f"Policy {policy_name} compliant: {compliant}"
                                            )
                                        ...
                                        if "reason" in compliance_report:
                                            ...
                                            logger.info(
                                                f"Policy {policy_name} reason: {reason}"
                                            )
...
async def evaluate_contract_only(
    ...
    try:
        ...
        logger.info(
            "Starting contract evaluation with EU AI Act policies and Phase 1 evaluators..."
        )
