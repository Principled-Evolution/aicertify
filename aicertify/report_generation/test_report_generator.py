...
def create_test_data() -> AggregatedReport:
    ...
    fairness_metrics = {
        ...
        "toxicity": {"name": "Toxicity Level", "value": 0.2, "control_passed": True},
    }
    ...
    safety_report = create_test_policy_report(
        "Content Safety Requirements", safety_metrics
    )

    # Create nested policy reports for EU AI Act
    eu_fairness_metrics = {
        "bias_score": {"name": "Bias Score", "value": 0.15, "control_passed": True},
        "fairness_index": {
            "name": "Fairness Index",
            "value": 0.85,
            "control_passed": True,
...
if __name__ == "__main__":
    ...
    print(
        "Generated report data. HTML report generation functionality has been moved or renamed."
    )
    # Old code that no longer works:
