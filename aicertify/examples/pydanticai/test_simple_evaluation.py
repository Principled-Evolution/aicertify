...
async def test_evaluation():
    ...
    for policy in policies:
        ...
        if "policy_results" in evaluation_results:
            policies_evaluated = evaluation_results["policy_results"]["policies_evaluated"]
            print(f"Policy: {evaluation_results['policy_results']['policy_category']}")
            print(f"Description: {evaluation_results['policy_results']['policy_description']}")
            ...
            for policy_result in evaluation_results["policy_results"]["policy_results"]:
                print(f"- {policy_result['policy_name']}: {policy_result['compliance_level']}")
