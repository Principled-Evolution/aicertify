...
class AccuracyEvaluator(BaseEvaluator):
    ...
    def _initialize(self) -> None:
        ...
        self.faithfulness_metric = FaithfulnessMetric(
            threshold=self.factual_consistency_threshold,
            model=self.model
        )
        ...
        try:
            ...
            if context is not None:
                if isinstance(context, str):
                    ...
                    logger.warning("Context must be a list of strings. Setting context to None.")
                    context = None
            
            # If no context provided, use an empty list instead of None
            if context is None:
                logger.warning("No context provided for accuracy evaluation. Using empty list for context.")
            ...
            is_factually_consistent = factual_consistency_score >= self.factual_consistency_threshold
