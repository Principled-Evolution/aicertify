...
base_fairness_rec := ["Review loan approval criteria for potential demographic bias", 
...
base_content_rec := ["Review financial advice for clarity and accuracy", 
...
base_risk_rec := ["Enhance documentation of loan risk assessment", 
...
recommendations := [] if is_compliant else := financial_recommendations
